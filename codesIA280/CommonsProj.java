...
public class CommonsProj extends JPanel  {
	private static final long serialVersionUID = 1L;
	private static JFrame frame;
	
	public final static Color3f Beige = new Color3f(0.96f, 0.87f, 0.7f);
	public final static Color3f LightBrown = new Color3f(0.71f, 0.4f, 0.16f);
	...
	public CommonsProj(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		frame = new JFrame("IA's Common File");           
		frame.getContentPane().add(new CommonsProj(create_Scene()));  
