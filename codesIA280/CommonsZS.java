...
public class CommonsZS extends JPanel {
	...
	public static RotationInterpolator rotate_Behavior_swing(int r_num, TransformGroup rotTG, Alpha rotationAlpha) {
	...
	public static RotationInterpolator rotate_Behavior(int r_num, TransformGroup rotTG,Transform3D Axis) {
	...
	public CommonsZS(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		frame = new JFrame("ZS's Common File");            // NOTE: change XY to student's initials
		frame.getContentPane().add(new CommonsZS(create_Scene()));  // create an instance of the class
