...
public class CommonsRA extends JPanel {
	...
	public final static Color3f[] clr_list = {Blue, Green, Red, Yellow,
			Cyan, Orange, Magenta, Grey,BlueA2,GreyA2};
	public final static int clr_num = 10;
	...
	static PointSound pointSound() {
		URL url = null;
		String filename = "C:\\Users\\romes\\eclipse-workspace\\COMP2800\src\\codesRA280\\sounds\\wind-1.wav";
		try {
	...
	static void enableAudio(SimpleUniverse simple_U) {
	...
	public static RotationInterpolator rotate_BehaviorZ(int r_num, TransformGroup rotTG) {

        rotTG.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
        Transform3D zAxis = new Transform3D();
        zAxis.rotX(Math.PI / 2.0);
        //yAxis.setRotation(new AxisAngle4f(180f, 0.0f, 0.0f, 1.0f));
        zAxis.setTranslation(new Vector3d(new Vector3f(-.465f, 0.68f, 0.0f)));
        Alpha rotationAlpha = new Alpha(-1, r_num);
        RotationInterpolator rot_beh = new RotationInterpolator(
	...
	public CommonsRA(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		frame = new JFrame("RA's Common File");            // NOTE: change XY to student's initials
		frame.getContentPane().add(new CommonsRA(create_Scene()));  // create an instance of the class
