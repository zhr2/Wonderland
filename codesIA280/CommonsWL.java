...
public class CommonsWL extends JPanel {
	private static final long serialVersionUID = 1L;
	private static JFrame frame; 
	public final static Color3f Red = new Color3f(1.0f, 0.0f, 0.0f);
	public final static Color3f Green = new Color3f(0.0f, 1.0f, 0.0f);
	public final static Color3f Pink = new Color3f(1.0f, 0.71f, 0.76f);
	...
	public final static Color3f BlueA2 = new Color3f(0.18f, 0.38f, 0.51f);///rgb(18,38,51)
	public final static Color3f GreyA2 = new Color3f(1.24f, 1.65f, 1.96f);//rgb(78,113,138)rgb(124,165,196)
	public final static Color3f Brown = new Color3f(0.48f, 0.33f, 0.24f);
	public final static Color3f[] clr_list = {Blue, Green, Red, Yellow,
			Cyan, Orange, Magenta, Grey,BlueA2,GreyA2,Brown};
	public final static int clr_num = 13;
	...
	public static void enableAudio(SimpleUniverse simple_U) {
        ...
        public static PointSound pointSound() {
			URL url = null;
			String filename = "/Users/ikramali/eclipse-workspace/COMP2800/sound/carnival.wav";
			try {
		...
		public static PointSound pointSoundBC() {
			URL url = null;
			String filename = "/Users/ikramali/eclipse-workspace/COMP2800/sound/magic_bells.wav";
			try {
				url = new URL("file", "localhost", filename);
			} catch (Exception e) {
				System.out.println("Can't open " + filename);
	...
	public static RotationInterpolator rotate_BehaviorTeaCup(int r_num, TransformGroup rotTG,Transform3D Axis) {

        rotTG.setCapability(TransformGroup.ALLOW_TRANSFORM_WRITE);
        Alpha rotationAlpha = new Alpha(-1, r_num);
        RotationInterpolator rot_beh = new RotationInterpolator(
                rotationAlpha, rotTG, Axis, 0.0f, (float) Math.PI * 2.0f);
        rot_beh.setSchedulingBounds(hundredBS);
        return rot_beh;
    }
	public static RotationInterpolator RotationBehaviorFW(TransformGroup targetTG, long rotationDuration) {
	    // Create a Transform3D object to store the axis and angle of rotation
		Transform3D yAxis = new Transform3D();
		yAxis.rotX(Math.PI / 2); // Rotate around the Y-axis

	    // Create an Alpha object that defines the rotation duration and loop count
	    Alpha rotationAlpha = new Alpha(-1, rotationDuration);
	    // Create the RotationInterpolator behavior and associate it with the Alpha object and TransformGroup
	    RotationInterpolator rotator = new RotationInterpolator(rotationAlpha, targetTG, yAxis, 0.0f, (float) Math.PI * 2);
	    // Set the scheduling bounds for the behavior
	...
	public CommonsWL(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		frame = new JFrame("Wonderland's Common File");            // NOTE: change XY to student's initials
		frame.getContentPane().add(new CommonsWL(create_Scene()));  // create an instance of the class
